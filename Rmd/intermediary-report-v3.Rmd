...
Put here an explanation about what it is.
...
set.seed(1234)
layout(matrix(c(1,2,3,4,5,6,7,8), 2, 4, byrow = TRUE),heights=c(1,1))
par(mar=c(0,0,0,0))
wordcloud::wordcloud(top1$features, top1$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
wordcloud::wordcloud(top1blogs$features, top1blogs$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
wordcloud::wordcloud(top1news$features, top1news$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
wordcloud::wordcloud(top1twitter$features, top1twitter$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
plot.new()
text(x=0.5, y=1, "Unii-Grams Global")
plot.new()
text(x=0.5, y=1, "Uni-Grams Blogs")
plot.new()
text(x=0.5, y=1, "Uni-Grams News")
plot.new()
text(x=0.5, y=1, "Uni-Grams Twitter")
...
require(gridExtra)
plot1 <- plotFeatures(top1[1:30,]) + ggtitle("Total")
plot2 <- plotFeatures(top1blogs[1:30,]) + ggtitle("Blogs")
plot3 <- plotFeatures(top1news[1:30,]) + ggtitle("News")
plot4 <- plotFeatures(top1twitter[1:30,]) + ggtitle("Twitter")
...
layout(matrix(c(1,2,3,4,5,6,7,8), 2, 4, byrow = TRUE),heights=c(1,1))
par(mar=c(0,0,0,0))
wordcloud::wordcloud(top2$features, top2$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
wordcloud::wordcloud(top2blogs$features, top2blogs$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
wordcloud::wordcloud(top2news$features, top2news$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
wordcloud::wordcloud(top2twitter$features, top2twitter$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
plot.new()
text(x=0.5, y=1, "Bi-Grams Global")
plot.new()
text(x=0.5, y=1, "Bi-Grams Blogs")
plot.new()
text(x=0.5, y=1, "Bi-Grams News")
plot.new()
text(x=0.5, y=1, "Bi-Grams Twitter")
```
...
require(gridExtra)
plot1 <- plotFeatures(top2[1:30,]) + ggtitle("Total")
plot2 <- plotFeatures(top2blogs[1:30,]) + ggtitle("Blogs")
plot3 <- plotFeatures(top2news[1:30,]) + ggtitle("News")
plot4 <- plotFeatures(top2twitter[1:30,]) + ggtitle("Twitter")
grid.arrange(plot1, plot2, plot3, plot4, ncol=4)
```
...
layout(matrix(c(1,2,3,4,5,6,7,8), 2, 4, byrow = TRUE),heights=c(1,1))
par(mar=c(0,0,0,0))
wordcloud::wordcloud(top3$features, top3$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
wordcloud::wordcloud(top3blogs$features, top3blogs$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
wordcloud::wordcloud(top3news$features, top3news$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
wordcloud::wordcloud(top3twitter$features, top3twitter$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1), max.words = 200)
plot.new()
text(x=0.5, y=1, "Tri-Grams Global")
plot.new()
text(x=0.5, y=1, "Tri-Grams Blogs")
plot.new()
text(x=0.5, y=1, "Tri-Grams News")
plot.new()
text(x=0.5, y=1, "Tri-Grams Twitter")
```
...
require(gridExtra)
plot1 <- plotFeatures(top3[1:30,]) + ggtitle("Total")
plot2 <- plotFeatures(top3blogs[1:30,]) + ggtitle("Blogs")
plot3 <- plotFeatures(top3news[1:30,]) + ggtitle("News")
plot4 <- plotFeatures(top3twitter[1:30,]) + ggtitle("Twitter")
grid.arrange(plot1, plot2, plot3, plot4, ncol=4)
```
...
http://rpubs.com/longwei66/word-predictor-exploratory-analysis
