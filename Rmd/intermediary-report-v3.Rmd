...
set.seed(1234)
wordcloud::wordcloud(top1$features, top1$freq, colors = brewer.pal(6, "Dark2"), scale = c(4, .1))
```
...
set.seed(1234)
wordcloud::wordcloud(top2$features, top2$freq, colors = brewer.pal(6, "Dark2"), scale = c(2, .1))
```
...
set.seed(1234)
wordcloud::wordcloud(top3$features, top2$freq, colors = brewer.pal(6, "Dark2"), scale = c(2, .1))
```
